...
export default function Home() {
  return (
    ...
    <main className="bg-[#0069C2] w-full h-[85vh] flex md:px-18 xl:px-32   flex-row sm:pl-[12px] pl-12">
   ...
   <Link href="email"><button className="bg-white p-4 rounded-3xl sm:w-[300px] whitespace-nowrap  text-[#0069C2] text-2xl mt-[30px]">Register Now</button></Link>
   </section>
